...
namespace NekoLegends
{
    public class NekoDemo : DemoScenes
    {
        ...
        public static new NekoDemo Instance
        {
            ...
            {
                if (_instance == null)
                    _instance = FindObjectOfType(typeof(NekoDemo)) as NekoDemo;
        ...
        protected override void Start()
        {
            ...
            GlobalVolumnBtnClicked(); //global volumn off - outlines not doing well in URP 12, only works well in URP 14+
