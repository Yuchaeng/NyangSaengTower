...
namespace NekoLegends
{
    public class NekoMew : MonoBehaviour
    {
        ...
        [SerializeField] private SkinnedMeshRenderer skinnedMeshRendererMain, skinnedMeshEyes;
        [SerializeField] private Material[] hairMaterials, eyeMaterials;
        [SerializeField] private Material[] outlines;
        [SerializeField] private GameObject collar, glasses;

        public Animator animator { get; private set; }


        private int _featureIndex, _emotionIndex, _currentOutlineIndex, _hairColorIndex, _currentEyeIndex, _currentPoseIndex = 0;

        private float _transitionDuration = 0.1f;
        private Material[] _hairMaterials, _eyeMaterials;
